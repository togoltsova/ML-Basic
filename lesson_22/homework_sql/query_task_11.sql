...
-- Попробуйте без документации понять назначение функции RANK().
-- -------------------------------------------------------------
--     RANK() нумерует строки по значению; одинаковым значениям выдает одинаковый номер(грейд);
...
-- ---------------------------------
-- А от DENSE_RANK()?
--      DENSE_RANK() нумерует строки по значению; одинаковым значениям выдает одинаковый номер(грейд);
